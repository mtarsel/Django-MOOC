...
urlpatterns = patterns('',
    ...
    url(r'^login/$', spine.views.login, name="login"),#login page for instructor and students
    url(r'^register/$', spine.views.register, name="register"),#register page for new users
